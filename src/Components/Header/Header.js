  ...
  return (
    <nav className="navbar navbar-expand-lg navbar-light bg-light sticky-top">
      <div className="container-fluid">
        ...
        <p className="navbar-brand text-dark fw-bold ">POETRY DAILY</p>
        ...
        <div className="collapse navbar-collapse" id="navbarTogglerDemo02">
          <div className="navbar-nav ms-auto mb-2 mb-lg-0">
            <Link className="fw-bold mx-2 text-dark text-decoration-none" to="/home"><i class="fas fa-home"></i> HOME</Link>
            <Link className="fw-bold mx-2 text-dark text-decoration-none" to="/explore"><i class="fab fa-wpexplorer"></i> EXPLORE BOOKS</Link>
            <Link className="fw-bold mx-2 text-dark text-decoration-none" to="/dashboard"><i class="fas fa-tachometer-alt"></i> DASHBOARD</Link>
