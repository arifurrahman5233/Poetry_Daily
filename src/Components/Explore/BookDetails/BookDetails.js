...
const BookDetails = () => {
    ...
    useEffect(() => {
        const url = `https://murmuring-scrubland-25292.herokuapp.com/books/${id}`;
        fetch(url)
            .then(res => res.json())
    ...
    const buyBook = e => {
        ...
        fetch('https://murmuring-scrubland-25292.herokuapp.com/order', {
            method: 'POST',
            headers: {
    ...
    const postReview = e => {
        ...
        fetch('https://murmuring-scrubland-25292.herokuapp.com/review', {
            method: 'POST',
            headers: {
                'content-type': 'application/json'
            },
